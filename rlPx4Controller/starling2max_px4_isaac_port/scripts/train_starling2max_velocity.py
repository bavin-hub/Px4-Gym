"""Train/evaluate the Starling 2 Max velocity task with RL-Games."""
...
parser.add_argument(
    "--config",
    type=Path,
    default=ROOT / "config/rl_games_starling2max_velocity.yaml",
)
...
env_cfg = Starling2MaxVelocityEnvCfg()
env_cfg.scene.num_envs = args.num_envs
env_cfg.sim.device = args.device
env = gym.make(STARLING2MAX_VELOCITY_TASK_ID, cfg=env_cfg)
